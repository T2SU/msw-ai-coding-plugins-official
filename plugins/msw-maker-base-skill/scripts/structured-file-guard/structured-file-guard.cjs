...
const POLICIES = [
  {
    ext: '.model',
    directReason:
      '.model files are builder-only. Use skills/msw-general/scripts/model/msw_model_builder.cjs (ModelBuilder.read/snapshot/fromTemplate/write), not direct Read/Edit/Write/MultiEdit.',
    bashReason:
      '.model files are builder-only. Do not read/edit/copy/delete them through shell commands. Use msw-general ModelBuilder; node commands that call the builder are allowed.',
  },
  {
    ext: '.ui',
    directReason:
      '.ui files are builder-only. Use skills/msw-ui-system/scripts/msw_ui_builder.cjs (UIBuilder.read/load/find/list_entities/write), not direct Read/Edit/Write/MultiEdit.',
    bashReason:
      '.ui files are builder-only. Do not read/edit/copy/delete them through shell commands. Use msw-ui-system UIBuilder; node commands that call the builder are allowed.',
  },
];
