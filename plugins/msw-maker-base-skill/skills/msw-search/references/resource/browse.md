...
```js
// Node.js
const { listResources } = require('<SKILL_PATH>/msw_resource_api.cjs');
...
```js
// Node.js
const { randomResources } = require('<SKILL_PATH>/msw_resource_api.cjs');
...
```js
// Node.js
const { findPacksContaining } = require('<SKILL_PATH>/msw_resource_api.cjs');
